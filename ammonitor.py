...
print(' [ '+ time.strftime('%H:%M:%S') + ' ] ' +  '--------@AnotherCop---------')
print(' [ '+ time.strftime('%H:%M:%S') + ' ] ' +  '-----------@Monitor-Beta------------')
print(' [ '+ time.strftime('%H:%M:%S') + ' ] ' +  '------------------------------')
...
def const_emb(status):
    ...
    embed.set_footer(text='@AnotherCop | Monitor-Beta | ' + time.strftime('%H:%M:%S'), icon_url = 'https://pbs.twimg.com/profile_images/1068858813263024128/X1vXvUbT_400x400.jpg')
